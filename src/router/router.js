...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'shop-dian', title: '商户店铺', name: 'shop-dian', component: () => import('@/views/shop/shop-list/shop-dian.vue') },
        { path: 'shop-admin', title: '商户店铺管理员', name: 'shop-admin', component: () => import('@/views/shop/shop-list/shop-admin.vue') },
