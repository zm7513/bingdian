            ...
            <Col>
                <Card>
                    ...
                    <Row class="operation">
                        ...
                        <Button @click="getShopDianList" icon="md-refresh">刷新</Button>
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            ...
                            if (params.row.status == 1 && this.$route.meta.permTypes.includes("disable")) {
                                ...
                                if(params.row.status == 1 && this.$route.meta.permTypes.includes("enable")){
                                    enableOrDisable = h(
                                        "Button",
                                        {
                                            props: {
                            ...
                            return h("div", [
                                ...
                                h(
                                    "Button",
                                    {
                                        ...
                                        on: {
                                            click: () => {
                                                this.shop_dian_goods(params.row);
                                            }
                                        }
                                    },
                                    "商品"
                                ...
                                h(
                                    "Button",
                                    {
                                        ...
                                        on: {
                                            click: () => {
                                                this.shop_dian_coupon(params.row);
                                            }
                                        }
                                    },
                                    "优惠活动"
...
//        console.log(v.purchase_price)
            ...
            getShopDianList() {
                ...
                if (this.searchKey === "" && this.startDate === "" && this.mobile === "") {
                    ...
                    this.getRequest('/shopDian/index', params).then(res => {
                        this.loading = false;
                        if (res.success === true) {
