...
// 获取菜单
export const getMenuList = "/admin/admin/getMenu_B"
// Websocket
...
export const login = (params) => {
    return postRequest('/admin/login', params)
}
// 获取用户登录信息
export const userInfo = (params) => {
    return getRequest('/admin/admin_info', params)
}
// 注册
...
export const changePass = (params) => {
    return postRequest('/admin/changePass', params)
}
// 个人中心修改手机
...
export const getUserListData = (params) => {
    return getRequest('/admin/index', params)
}
// 通过用户名搜索
...
export const getAllUserData = (params) => {
    return getRequest('/admin/getAdminAll', params)
}
// 通过部门获取全部用户数据
...
export const addUser = (params) => {
    return postRequest('/admin/addAdmin', params)
}
// 编辑用户
export const editUser = (params) => {
    return postRequest('/admin/adminEdit', params)
}
// 启用用户
...
export const disableUser = (params) => {
    return postRequest(`/admin/editStatus`, params)
}
// 删除用户
export const deleteUser = (ids, params) => {
    return postRequest(`/admin/delAll`, params)
}
// 导入用户
...
// 获取一级部门
export const initDepartment = (params) => {
    return getRequest('/admin/index/0', params)
}
// 加载部门子级数据
...
export const getAllRoleList = (params) => {
    return getRequest('/admin/getAllRole', params)
}
// 分页获取角色数据
export const getRoleList = (params) => {
    return getRequest('/adminRole/index', params)
}
// 添加角色
export const addRole = (params) => {
    return postRequest('/adminRole/addRole', params)
}
// 编辑角色
export const editRole = (params) => {
    return postRequest('/adminRole/editRole', params)
}
// 设为或取消注册角色
export const setDefaultRole = (params) => {
    return postRequest('/adminRole/setDefault', params)
}
// 分配角色权限
export const editRolePerm = (params) => {
    return postRequest('/adminRole/setPermissionMenu', params)
}
...
export const deleteRole = (params) => {
    return getRequest('/adminRole/delAllRole', params)
}
...
export const getAllPermissionList = (params) => {
    return postRequest('/permission/editMenuList', params)
}
// 获取全部权限数据
export const getAllPermissionListAll = (params) => {
...
export const editPermission = (params) => {
    return postRequest('/permission/editPermissionMenu', params)
}
// 删除权限
